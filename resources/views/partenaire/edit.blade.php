	...
	<div class="container col-xs-12">
		...
		<div class="row">
			<div class="box-header col-xs-12">
				<h3 class="box-title">Modifier le partenaire N : {{$par->id}}</h3>
			</div>
	  </div>

		@include('layouts/partials/_menuPartenaire')

		<form class="well form-horizontal" method="POST" action="{{route('partenaires.update', $par)}}" id="contact_form" enctype="multipart/form-data">
			@csrf
			@method('PUT')
			<fieldset>
			<!-- Nom du Partenaire -->
			<div class="form-group ">
				...
				<div class="col-md-9 inputGroupContainer @if($errors->get('name')) has-error @endif">
					<div class="input-group">
						...
						<input  name="name" placeholder="Nom" class="form-control"  type="text" value="{{old('name') ?? $par->name}}">
					</div>
				</div>
			</div>
			...
			<label class="col-md-3 control-label">Type *</label>
				<div class="col-md-9 selectContainer @if($errors->get('type')) has-error @endif">
					...
					<span class="input-group-addon"><i class="fa fa-bars"></i></span>
						<select name="type" class="form-control selectpicker" value="{{old('type') ?? $par->type}}">
			...
			<div class="form-group ">
				...
				<div class="col-md-9 inputGroupContainer @if($errors->get('pays')) has-error @endif">
					<div class="input-group">
						...
						<input  name="pays" placeholder="Pays" class="form-control"  type="text" value="{{old('pays') ?? $par->pays}}">
					</div>
				</div>
			</div>
			...
			<div class="form-group ">
				...
				<div class="col-md-9 inputGroupContainer @if($errors->get('ville')) has-error @endif">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
						<input  name="ville" placeholder="Ville" class="form-control"  type="text" value="{{old('ville') ?? $par->ville}}">
					</div>
				</div>
			</div>
			...
			<div class="form-group ">
				...
				<div class="col-md-9 inputGroupContainer @if($errors->get('adresse')) has-error @endif">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
						<input  name="adresse" placeholder="Adresse" class="form-control"  type="text" value="{{old('adresse') ?? $par->adresse}}">
					</div>
				</div>
			</div>
			...
			<div class="form-group ">
				...
				<div class="col-md-9 inputGroupContainer @if($errors->get('email')) has-error @endif">
					<div class="input-group">
						...
						<input  name="email" placeholder="Email" class="form-control"  type="text" value="{{old('email') ?? $par->email}}">
					</div>
				</div>
			</div>
			...
			<div class="form-group ">
				...
				<div class="col-md-9 inputGroupContainer @if($errors->get('telephone')) has-error @endif">
					<div class="input-group">
						...
						<input name="telephone" placeholder="Telephone" class="form-control" type="tel" value="{{old('telephone') ?? $par->telephone}}">
					</div>
				</div>
			</div>
			...
			<div style="padding-top: 30px; margin-left: 35%;">
				...
				<button type="submit" class=" btn btn-lg btn-primary"><i class="fa fa-check"></i> Modifiers</button> 
			</div>
