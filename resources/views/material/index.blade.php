                    ...
                    <div class="btn-group col-md-12" role="group" aria-label="Basic example">
                        ...
                        @if(Auth::user()->role->nom == 'admin')
                            ...
                            <a href="{{route('materials.create')}}" class="btn btn-primary btn-sm"><i
                                        class="fa fa-plus"></i><b> Matériel</b></a>
                            <a href="{{route('materials.category')}}" class="btn btn-primary btn-sm"><i
                                        class="fa fa-plus"></i><b> Categorie</b></a>
                        @endif
                    </div>
                        ...
                        @foreach($materials as $material)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('materials.history', $material->id)}}"
                                    ...
                                    @if(Auth::user()->role->nom == 'admin')
                                        ...
                                        <a href="#supprimer{{ $material->id }}Modal" role="button"
                                           class="btn btn-danger btn-sm" data-toggle="modal"><i
                                                    class="fa fa-trash-o"></i></a>

                                        <div class="modal fade" id="supprimer{{ $material->id }}Modal" tabindex="-1"
                                             role="dialog" aria-labelledby="supprimer{{ $material->id }}ModalLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        ({{$material->category}} | {{$material->numero}}) ?
                                                    </div>
