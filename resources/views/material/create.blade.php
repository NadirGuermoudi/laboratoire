...
@section('title','LRI | Ajouter un matériel')
...
@section('header_page')
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="{{route('materials.create')}}">Nouveau</a></li>
	</ol>
@endsection
	  ...
	  <div class="container">
		  <div class="row">
				<div class="box-header col-xs-12">
					<h3 class="box-title">Nouveau matériel</h3>
				</div>
		  </div>
					...
					<fieldset>
						<div class="form-group ">
							...
							<div class="col-xs-9 inputGroupContainer @if($errors->get('category')) has-error @endif">
								<div style="width: 70%">
									<select name="category" class="form-control select2" value="{{old('category')}}">
									<option></option>
						...
						<div class="form-group">
							...
							<label class="col-xs-9 control-label" title="empruntable?">
								<input name="empruntable" type="checkbox" class="flat-red" checked>
							</label>
						</div>

						<div class="form-group">
						<label class="col-xs-3 control-label">Prix (DA)</label>  
							<div class="col-xs-9 inputGroupContainer @if($errors->get('prix')) has-error @endif">
								<div style="width: 70%">
									<input  name="prix" class="form-control" placeholder="Prix en DA" type="number" value="{{old('prix')}}">
								</div>
							</div>
						</div>
