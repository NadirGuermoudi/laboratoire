                ...
                <div class="container" style="padding-top: 30px">
                    <div class="row">
                        <div class="box-header col-xs-11">
                            <legend>
                                <center><h2><b>EQUIPES</b></h2></center>
                            </legend>
                        </div>
                                    ...
                                    <div class="box box-widget widget-user">
                                        ...
                                        @if(Auth::user()->role->nom == 'admin' )
                                            ...
                                            {{method_field('DELETE')}}
                                                ...
                                                <a href="#supprimer{{ $equipe->id }}Modal" role="button"
                                                   class="btn btn-box-tool" data-toggle="modal"><i
                                                            class="fa fa-times"></i></a>
                                                <div class="modal fade" id="supprimer{{ $equipe->id }}Modal"
                                                     tabindex="-1" role="dialog"
                                                     aria-labelledby="supprimer{{ $equipe->id }}ModalLabel"
                                                     aria-hidden="true">
                                        ...
                                        <div class="widget-user-header bg-aqua-active">
                                            <a class="users-list-name1"
                                               href="{{ url('equipes/'.$equipe->id.'/details')}}"><h3
                                                        class="widget-user-username">{{$equipe->intitule}}</h3></a>
                                            <h5 class="widget-user-desc">{{$equipe->achronymes}}</h5>
                                        </div>
                                        <div class="widget-user-image">
                                            <img class="img-circle" src="{{asset($equipe->chef->photo)}}"
                                                 alt="User Avatar">
                                        </div>
                                                ...
                                                <div class="col-sm-4 border-right">
                                                    <div class="description-block">
                                                        ...
                                                        <span class="description-text"><a
                                                                    href="{{url('membres/'.$equipe->chef_id.'/details')}}"
