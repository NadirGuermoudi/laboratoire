                ...
                <div class="container col-xs-12">
                    ...
                    <form class="well form-horizontal" action=" {{url('equipes')}} " method="post" id="contact_form" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <legend>
                                <center><h2><b>Nouvelle équipe</b></h2></center>
                            </legend>
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9 inputGroupContainer @if($errors->get('intitule')) has-error @endif">
                                    <div style="width: 70%">
                                        <input name="intitule" class="form-control" placeholder="intitule" type="text"
                                               value="{{old('titre')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div style="width: 70%">
                                        <input name="achronymes" class="form-control" placeholder="intitule" type="text"
                                               value="{{old('achronymes')}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9 inputGroupContainer @if($errors->get('resume')) has-error @endif">
                                    <div style="width: 70%">
                                        <textarea name="resume" class="form-control" rows="3"
                                                  placeholder="Entrez ...">{{old('resume')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div style="width: 70%">
                                        <textarea name="axes_recherche" class="form-control" rows="3"
                                                  placeholder="Entrez ...">{{old('axes_recherche')}}</textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row" style="padding-top: 30px; margin-left: 35%;">
                            <a href="{{url('equipes')}}" class=" btn btn-lg btn-default"><i
                                        class="fa  fa-mail-reply"></i> &nbsp;Annuler</a>
